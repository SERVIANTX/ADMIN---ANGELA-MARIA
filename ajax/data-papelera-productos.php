    ...
    class DatatableController{
        ...
        public function data(){
            ...
            if(!empty($_POST)){
                ...
                $url = "products?select=id_product&linkTo=date_updated_product&between1=".$_GET["between1"]."&between2=".$_GET["between2"]."&filterTo=status_product&inTo=0";
                ...
                $select = "id_product,name_product,url_product,url_category,picture_product,price_product,productoffer_product,stock_product,maxquantitysale_product,description_product,summary_product,sales_product,views_product,status_product,id_category_product,id_brand_product,date_updated_product";

                if(!empty($_POST['search']['value'])){

                    if(preg_match('/^[0-9A-Za-zñÑáéíóú ]{1,}$/',$_POST['search']['value'])){

                        $linkTo = ["name_product","date_updated_product"];

                        $search = str_replace(" ", "_", $_POST['search']['value']);

                        foreach($linkTo as $key => $value) {

                            $url = "relations?rel=products,categories&type=product,category&select=".$select."&linkTo=".$value.",status_product&search=".$search.",0&orderBy=".$orderBy."&orderMode=".$orderType."&startAt=".$start."&endAt=".$length;
                    ...
                    $url = "relations?rel=products,categories&type=product,category&select=".$select."&linkTo=date_updated_product&between1=".$_GET["between1"]."&between2=".$_GET["between2"]."&orderBy=".$orderBy."&orderMode=".$orderType."&startAt=".$start."&endAt=".$length."&filterTo=status_product&inTo=0";
                    ...
                    foreach($data as $key => $value){
                        ...
                        if($_GET["text"] == "flat"){
                            ...
                            $actions = "<div class='btn-group'>
                                        ...
                                        <a href='/productos/editar/".base64_encode($value->id_product."~".$_GET["token"])."' class='btn btn-outline-success-jrfd btn-sm rounded-circle mr-2'>
