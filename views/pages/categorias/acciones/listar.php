...
<div class="card">
        ...
        <div class="card-tools">
            ...
            <div class="calendar-container mb-30">
                ...
                <div class="calendar-header">
                    <button type="button" onclick="nuevaCategoria()"><i class="fa fa-plus mr-2"></i> Nueva Categoria</button>
                </div>
    ...
    <div class="card-body">
        <table id="TablaAdministradores" class="table table-striped tableCategorias">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Imagen</th>
