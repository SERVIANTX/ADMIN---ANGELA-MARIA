...
<div class="card">
        ...
        <div class="card-tools">
            ...
            <div class="calendar-container mb-30">
                ...
                <div class="calendar-header">
                    <button type="button" onclick="nuevaSubCategoria()"><i class="fa fa-plus mr-2"></i> Nueva Sub-Categoria</button>
                </div>
    ...
    <div class="card-body">
        <table id="TablaAdministradores" class="table table-striped tableSubcategorias">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Nombre</th>
