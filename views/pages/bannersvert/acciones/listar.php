...
<div class="card">
        ...
        <div class="card-tools">
            ...
            <div class="calendar-container mb-30">
                ...
                <div class="calendar-header">
                    <button type="button" onclick="nuevoBannerVertical()"><i class="fa fa-plus mr-2"></i> Nuevo Banner</button>
                </div>
    ...
    <div class="card-body">
        ...
        <table id="TablaAdministradores" class="table table-bordered table-striped tableBannersVert">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Imagen</th>
