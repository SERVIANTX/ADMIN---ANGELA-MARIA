...
<div class="card">
    ...
    <div class="card-body">
        ...
        <table id="TablaAdministradores" class="table table-bordered table-striped tableOfertas">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Acciones</th>
...
<div class="modal fade basicModalLG" id="infoOffert" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
